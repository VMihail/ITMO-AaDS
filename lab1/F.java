...
public class Problem {
    ...
    static class Solver {
        ...
        public void solve() {
            ...
            int[] first = nextIntArray(n);
            while (m-- > 0) {
                int key = scanInt();
                out.println(nearest(first, key));
            }
        }

        private int nearest(int[] array, int key) {
            ...
            int firstRange = abs(array[left] - key), secondRange = abs(array[right] - key);
